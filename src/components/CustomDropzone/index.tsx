...
const CustomDropzone = ({ totalFile, onDrop }: ICustomDropzone) => {
  const [filePdfPreview, setFilePdfPreview] = useState<string | undefined>(undefined)
